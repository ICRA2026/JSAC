...
from jsac.envs.torchdriveenv.env import DriveEnv
...
def parse_args():
    ...
    parser.add_argument('--env_name', default='torchdriveenv-v0', type=str)
    ...
    parser.add_argument('--update_sync', default=True, action='store_true')
...
def main(seed=-1):
    ...
    env = DriveEnv(args.env_name, config_path="../../jsac/envs/torchdriveenv/training.yml")
    ...
    args.proprioception_shape = None
